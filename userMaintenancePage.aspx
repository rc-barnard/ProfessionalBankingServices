<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userMaintenancePage.aspx.cs" Inherits="_45096600_Individual_Webpages.userMaintenancePage" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style5" colspan="3">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="False" Font-Size="30pt" Text="Manage users here, " Font-Names="Garamond" ForeColor="White"></asp:Label>
            ...
            <tr>
                <td class="auto-style5" colspan="3">
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:Button ID="btnDisplayEmployees" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" ForeColor="Black" Height="53px" Text="Show Employee Details" Width="227px" OnClick="btnDisplayEmployees_Click" />
&nbsp;
                                <asp:Button ID="btnAddEmployee" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" ForeColor="Black" Height="53px" Text="Add Employee Details" Width="227px" OnClick="btnAddEmployee_Click" TabIndex="1" />
&nbsp;
                                <asp:Button ID="btnChangeEmployee" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" ForeColor="Black" Height="53px" Text="Change Employee Details" Width="227px" OnClick="btnChangeEmployee_Click" TabIndex="2" />
&nbsp;
                                <asp:Button ID="btnRemoveEmployee" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" ForeColor="Black" Height="53px" Text="Delete Employee Details" Width="227px" OnClick="btnRemoveEmployee_Click" TabIndex="3" />
                            &nbsp;
                                <asp:Button ID="btnReturnDashboard" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" Height="53px" OnClick="btnReturnDashboard_Click" Text="Return to Dashboard" Width="277px" TabIndex="4" />
                            </td>
                        </tr>
                        </table>
                </td>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style46">
                    <asp:Label ID="lblEmployee" runat="server" Font-Bold="True" Font-Names="Garamond" Font-Size="20pt" ForeColor="Black" Text="Employee Information:" Visible="False"></asp:Label>
                </td>
