<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transactionStatementPage.aspx.cs" Inherits="_45096600_Individual_Webpages.transactionStatementPage" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style5">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="False" Font-Size="30pt" Text="Access transactions statement here, " Font-Names="Garamond" ForeColor="White"></asp:Label>
                    ...
                    <asp:DropDownList ID="dropListOrderBy" runat="server" Width="210px" TabIndex="2">
                        ...
                        <asp:ListItem>Date Descending</asp:ListItem>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="auto-style27">
                    <asp:Label ID="lblOrderBy0" runat="server" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt">Transaction type:</asp:Label>
                                        </td>
                                        <td class="auto-style28" colspan="2">
                                            <asp:DropDownList ID="dropListTransactionType" runat="server" Width="210px" TabIndex="3">
                    ...
                    <asp:Label ID="lblEmail" runat="server" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt">Send a copy to my email:</asp:Label>
                                        ...
                                        <td class="auto-style28" colspan="2">
                    <asp:CheckBox ID="CheckBoxYes" runat="server" OnCheckedChanged="CheckBoxYes_CheckedChanged" Text="Yes" TabIndex="4" />
&nbsp;
                    <asp:CheckBox ID="CheckBoxNo" runat="server" OnCheckedChanged="CheckBoxYes_CheckedChanged" Text="No" TabIndex="5" />
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="auto-style27">
                    <asp:Button ID="btnSubmit" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" Height="53px" OnClick="btnSubmit_Click" Text="Submit" Width="277px" TabIndex="6" />
                                        </td>
                                        <td class="auto-style28" colspan="2">
                    <asp:Button ID="btnReturnDashboard" runat="server" BackColor="#33CC33" BorderColor="Black" BorderStyle="Double" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" Height="53px" OnClick="btnReturnDashboard_Click" Text="Return to Request Reports" Width="277px" TabIndex="7" />
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                    ...
                    <asp:Label ID="lblReportTitle" runat="server" Font-Bold="True" Font-Names="Garamond" Font-Size="13pt" Visible="False">Transactions Statement from </asp:Label>
