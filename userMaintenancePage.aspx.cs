...
{
    public partial class userMaintenancePage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnDisplayEmployees.Focus();
        }

        protected void btnDisplayEmployees_Click(object sender, EventArgs e)
        {
        ...
        protected void btnChangeEmployee_Click(object sender, EventArgs e)
        {
            ...
            BindGridView();
            DisplayControls();
            lblInstruction.Text = "Select UserID from the dropdown list and provide employee details to change:";
        ...
        public void populateDropdownLists()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                string populateDroplist = "SELECT UserID FROM Users";
        ...
        protected void btnChange_Click(object sender, EventArgs e)
        {
            ...
            int userID = int.Parse(dropListChange.SelectedValue.ToString());
            ...
            lblWarning.Text = "Are you sure you want to change employee details?";
            lblWarning.Visible = true;
            btnYes.Visible = true;
            btnNo.Visible = true;
            btnChange.Visible = false;
        ...
        public void populateInputControls()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                    ...
                    {
                        conn.Open();
                        string query = "SELECT FirstName, Surname, ContactNumber, EmailAddress, DateOfBirth, UserName, Password, Role FROM Users WHERE UserID = @UserID";
                        using (var cmd = new SqlCommand(query, conn))
                        {
                            cmd.Parameters.AddWithValue("@UserID", dropListChange.SelectedValue);
                    ...
                    {
                        lblWarning.Text = "An error occured loading employee's details: " + ex;
                        lblWarning.Visible = true;
                    }
            }
        }
        ...
        protected void btnYes_Click(object sender, EventArgs e)
        {
                ...
                if (validateInput())
                {
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        try
                        {
                            ...
                            string sql = "UPDATE Users SET FirstName = @FirstName, Surname = @Surname, ContactNumber = @ContactNumber, EmailAddress = @EmailAddress, DateOfBirth = @DateOfBirth, UserName = @UserName, Password = @Password, Role = @Role WHERE UserID = @UserID";
                        ...
                        {
                            lblWarning.Text = "An error occured changing employee details: " + ex.Message;
                            lblWarning.Visible = true;
                        }
                    }
                }
                ...
                if (validateInput() == true)
                {
                    using (var conn = new SqlConnection(connectionString))
                    {
                        try
                        {
                            ...
                            sql = "INSERT INTO Users (FirstName, Surname, ContactNumber, EmailAddress, DateOfBirth, UserName, Password, Role) " +
                                      "VALUES (@FirstName, @Surname, @ContactNumber, @EmailAddress, @DateOfBirth, @UserName, @Password, @Role)";
                            ...
                            {
                                lblMessage.Text = "Employee details added unsuccesfully! Please try again.";
                                lblMessage.Visible = true;
                            }
                        }
                        catch (SqlException ex)
                        {
                            lblWarning.Text = "An error occured adding employee details: " + ex;
                            lblWarning.Visible = true;
                        }
                    }
                }
            ...
            else if(fieldTypeConfirm.Value == "Delete")
            {
                using(SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    {
                        conn.Open();
                        string sql = $"DELETE FROM Users WHERE UserID = @num";
                        SqlCommand cmd = new SqlCommand(sql, conn);
                        cmd.Parameters.AddWithValue("@num", dropListID.SelectedValue);
                        int executedRows = cmd.ExecuteNonQuery();
                        if (executedRows > 0)
                        {
                            lblMessage.Text = "Employee details removed successfully!";
                            lblMessage.Visible = true;
                        }
                        else
                        {
                            lblMessage.Text = "Employee details removed unsuccesfully! Please try again.";
                            lblMessage.Visible = true;
                        }
                    }
                    catch (SqlException ex)
                    {
                        lblMessage.Text = "Failed to remove employee " + ex.Message;
                    }
                }
            }
            populateDropdownLists();
        ...
        protected void btnAddEmployee_Click(object sender, EventArgs e)
        {
            ...
            lblWarning.Visible = false;
            BindGridView();
            lblInstruction.Text = "Please provide employee details to add:";
            lblInstruction.Visible = true;
            btnAdd.Visible = true;
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            lblWarning.Text = "Are you sure you want to add employee details?";
            lblWarning.Visible = true;
            btnYes.Visible = true;
            btnNo.Visible = true;
            btnAdd.Visible = false;
        ...
        protected void btnRemoveEmployee_Click(object sender, EventArgs e)
        {
            lblWarning.Visible = false;
            lblMessage.Visible = false;
            lblInstruction.Text = "Select UserID from the dropdown list to delete:";
            lblInstruction.Visible = true;
            dropListChange.Visible = false;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            lblWarning.Text = "Are you sure you want to delete employee details?";
            lblWarning.Visible = true;
            btnYes.Visible = true;
            btnNo.Visible = true;
            btnDelete.Visible = false;
